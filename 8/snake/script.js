...
//
//   // (coordY == FIELD_SIZE_Y-1) && (coordY = 0);
//   // (coordX == FIELD_SIZE_X-1) && (coordX = 0);
//   // console.log( direction,  coordX, coordY );
//   switch(direction) {
//     case 'x-':
//       (coordX == 0) && (coordX = FIELD_SIZE_X);
//       newUnit = document.getElementsByClassName('cell-' + (coordX - 1) + '-' + coordY)[0];
//       break;
//     case 'x+':
//       (coordX == FIELD_SIZE_X-1) && (coordX = -1);
//       newUnit = document.getElementsByClassName('cell-' + (coordX + 1) + '-' + coordY)[0];
//       break;
//     case 'y-':
//       (coordY == 0) && (coordY = FIELD_SIZE_Y);
//       newUnit = document.getElementsByClassName('cell-' + coordX + '-' + (coordY - 1))[0];
//       break;
//     case 'y+':
//       (coordY == FIELD_SIZE_Y-1) && (coordY = -1);
//       newUnit = document.getElementsByClassName('cell-' + coordX + '-' + (coordY + 1))[0];
//       break;
//   }
//
